...
<body>
    ...
    <br>
    <div class="container">
        <h3 class="position-relative">Exchange your Products here</h3>
    </div>
    <br>
    <br>
    <div class="container">
        <h4>Enter Details about your product</h4>
        <form action="sell" method="post" enctype="multipart/form-data">
            <div class="mb-3 row">
                <label for="prodname" class="col-sm-2 col-form-label">Product Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="prodname" name="prodname" placeholder="Enter Product Name" onkeyup="predictCategory()" required>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="brand" class="col-sm-2 col-form-label">Brand</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="brand" name="brand" placeholder="Enter Brand" onkeyup="predictCategory()" required>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="model" class="col-sm-2 col-form-label">Model</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="model" name="model" placeholder="Enter Model" onkeyup="predictCategory()" required>
                </div>
            </div>
            <div class="mb-3 row">
